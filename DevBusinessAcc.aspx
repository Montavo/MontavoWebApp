<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DevBusinessAcc.aspx.cs" Inherits="DevBusinessAcc" %>
   ...
   <%-- <div class="center span12">
    ...
    <div class="box">
					<div class="box-header well" data-original-title="">
						<h2><i class="icon-add" ></i>Create Business Account</h2>
    ...
    <div  class="control-group"> 
                            ...
                            <asp:Label ID="lblCompName"  CssClass="control-label" for="txtCompName" runat="server">Company Name</asp:Label>
								<div class="controls">
                                <asp:TextBox ID="txtCompName" CssClass="span6 typeahead"   Height="20px" Width="219px" runat="server"></asp:TextBox>
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator2" CssClass="validator"  ControlToValidate="txtCompName" runat="server" ErrorMessage="Required"></asp:RequiredFieldValidator>
            ...
            <div  class="control-group"> 
                 ...
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" CssClass="validator"  ControlToValidate="txtAddress" runat="server" ErrorMessage="Required"></asp:RequiredFieldValidator>
