<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PublisherAddUser.aspx.cs" Inherits="PublisherAddUser" %>
...
<body>
   ...
   <div class="container">
    ...
    <li class="active"><a href="#">Step3-Add Users</a><span class="divider">/</span></li>
    ...
    <div class="box">
					<div class="box-header well" data-original-title="">
						<h2><i class="icon-user"></i> Add New User</h2>
