...
namespace BinaryIntellect.DataAccess
{
    public class DatabaseHelper:IDisposable
    {
        ...
        public DatabaseHelper(Providers provider)
            : this(ConfigurationManager.ConnectionStrings["MontavoConnectionString"].ConnectionString, provider)
        {
        }
        ...
        public DatabaseHelper()
            : this(ConfigurationManager.ConnectionStrings["MontavoConnectionString"].ConnectionString, Providers.ConfigDefined)
        {
        }
