<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditPlacement.aspx.cs" Inherits="EditPlacement" %>
...
<body>
    <form id="form1" class="form-horizontal center" runat="server">
     <uc2:Header ID="Header1" runat="server" />
    <div>
    <div class="box span12">
					<div class="box-header well" data-original-title="">
			        <h2> <i class="icon-edit" ></i>Edit Placement</h2>
					</div>
           ...
           <div  class="control-group">          
                  ...
                  <div  class="control-group">    
                    ...
                    <div class="form-actions">
                            <asp:Button ID="btnAds" runat="server" Text="Edit Placement" 
