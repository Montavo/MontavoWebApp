<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeveloperSteps.aspx.cs" Inherits="DeveloperSteps" %>
...
<div class="center">
   ...
   <center><h2 class="center">Developer Signup</h2>
  </center> 
  ...
  <ul>
    <li><a href="#step-1">
          ...
          <span class="stepDesc">
             Step 1<br />
             <small>Register Mobile Apps</small>
          </span>
      </a></li>
    <li><a href="#step-2">
  ...
  <div id="step-1">   
      <h2 class="StepTitle">Register Mobile Apps</h2>
       <!-- step content -->
        <div  class="control-group"> 
          ...
          <div  class="control-group"> 
		              ...
		              <asp:RequiredFieldValidator ID="RequiredFieldValidatorurl" CssClass="validator"  ControlToValidate="txtmarketurl" runat="server" ErrorMessage="Required"></asp:RequiredFieldValidator>
           ...
           <div class="control-group"> 
             ...
             <asp:RequiredFieldValidator ID="RequiredFieldValidato" CssClass="validator"  ControlToValidate="txtnotes" runat="server" ErrorMessage="Required"></asp:RequiredFieldValidator>
