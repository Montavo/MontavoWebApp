<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PublisherPaypal.aspx.cs" Inherits="PublisherPaypal" %>
...
<body>
    ...
    <div class="box ">
					<div class="box-header well" data-original-title="">
						<h2><i class="icon-gift" ></i>Add Payment Method</h2>
             ...
             <div  class="control-group">                
						    ...
						    <div class="controls">
                             <asp:TextBox ID="txtnotes" CssClass="span6 typeahead" TextMode="MultiLine" Columns="50" Rows="5" runat="server"></asp:TextBox>
		                      <asp:RequiredFieldValidator ID="RequiredFieldValidator4" CssClass="validator"  ControlToValidate="txtnotes" runat="server" ErrorMessage="Required"></asp:RequiredFieldValidator>
