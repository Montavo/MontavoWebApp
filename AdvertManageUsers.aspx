<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdvertManageUsers.aspx.cs" Inherits="AdvertManageUsers" %>
...
<body>
    ...
    <div class="span12 center">
        <h3>
   Advertiser-Manage Users
    </h3>
    <div class="breadcrumb"> 
    <ul>
 <li><a href="AdvertManageBusiness.aspx">Manage Business</a><span class="divider">|</span></li>
           ...
           EmptyDataText="No USers To Display" 
                ...
                <asp:BoundField HeaderText="Notes" DataField="fldNotes" />--%>
                 <asp:TemplateField > 
                    <ItemTemplate>
                        ...
                        NavigateUrl='<%# "EditAdevertUser.aspx?ID="+Eval("fldUserId") %>' 
                ...
                <div class="span5 center">
                      ...
                      <asp:HyperLink ID="lnkAdd" Text="Add User" CssClass="btn btn-primary btn-large"  
                        NavigateUrl="AdvertAddUser.aspx"
                        Runat="server"></asp:HyperLink>
