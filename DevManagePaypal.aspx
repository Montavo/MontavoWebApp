<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DevManagePaypal.aspx.cs" Inherits="DevManagePaypal" %>
...
<body>
    ...
    <div class="box span12 center">
					...
					<div class="box-header well" data-original-title>
                     ...
                     <i class="icon-edit"></i>  <asp:Label ID="Label1" runat="server" Text="Manage Payment method"></asp:Label> </h2>						
					</div>
            ...
            EnableModelValidation="True"  EmptyDataText="No USers To Display" CssClass="table table-striped table-bordered bootstrap-datatable datatable dataTable">
                ...
                <asp:BoundField HeaderText="Email" DataField="fldEmail" />
                ...
                <asp:BoundField HeaderText="Notes" DataField="fldNotes" />--%>
                   <asp:TemplateField > 
                    <ItemTemplate>
                         ...
                         <asp:HyperLink ID="lnkEdit" Text="Edit Method" CssClass="btn-mini btn-primary" 
                        NavigateUrl='<%# "EditDeveloperpaypal.aspx?ID="+Eval("fldpaymentid") %>' 
                        Runat="server"></asp:HyperLink>

                      <%--  <asp:Button ID="btnRemoveWeb"  runat="server" Text="Delete"
                         CommandName="deleteWeb" 
                         CommandArgument='<%# Eval("fldpaymentid") %>'
                         CssClass="btn btn-mini btn-danger btn-round"  />--%>

                        <asp:HyperLink ID="HyperLink1" Text="Delete" CssClass="btn-mini btn-danger" 
                        NavigateUrl='<%# "DeletePaymentMethod.aspx?ID="+Eval("fldpaymentid") %>' 
                        Runat="server"></asp:HyperLink>
                         </ItemTemplate>
                     </asp:TemplateField>
