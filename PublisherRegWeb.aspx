<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PublisherRegWeb.aspx.cs" Inherits="PublisherRegWeb" %>
    ...
    <div>
     <div class="box">
					<div class="box-header well" data-original-title="">
						<h2><i class="icon-pencil"></i>Register Websites</h2>
					</div>
                   ...
                   <div  class="control-group"> 
                       ...
                       <div  class="control-group">                
                           ...
                           <div class="form-actions">
                            <asp:Button ID="btnAdd" runat="server" Text="Add Website" 
